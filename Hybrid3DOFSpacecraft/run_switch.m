...
%  xi = [10000 0 0.5 0];    zi = [ 0 0.5];                   
%  xi = [0  0 0 0.5];  zi = [10000  0.5];                     

    % starting from phase 2
%  xi = [-700*cosd(45) -700*sind(45) 0.45 0.45];   zi = [0 0];      
%  xi = [700*cosd(1) 0 0.45 0];  zi = [-700*sind(1) 0.45];          
%  xi = [0 -700*cosd(45) 0 0.45];  zi = [-700*sind(45) 0.45];       
